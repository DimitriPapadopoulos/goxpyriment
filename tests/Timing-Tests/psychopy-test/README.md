...
> [!WARNING] This code was entirely generated by an AI agent asked to translate Timing-tests/main.go into Python using psychopy.
> There is no guarantee that the code is optimal. So do not use this a serious test of psychopy capabilities.
