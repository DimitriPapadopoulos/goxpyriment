...
* maybe movies playing should be considered as a kind of stream (see stimuli/streams.go). It would be great if they can return input events. Yet, I think we may want the retain the possbility to pause movies, rewind them, ... This is not what stresm do. To be discussed.
